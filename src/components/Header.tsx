      ...
      <div className="container mx-auto px-4 py-4">
        <div className="flex items-center justify-between">
          ...
          <nav className="hidden md:flex space-x-8">
            ...
            <a href="#schedule" className="text-white hover:text-viking-orange transition-colors">Расписание</a>
            <a href="#media" className="text-white hover:text-viking-orange transition-colors">Медиа</a>
